    ...
    <div className="flex h-full flex-col overflow-hidden p-8 lg:p-12">
      <header className="mb-8 flex items-start justify-between">
        ...
        <button
          ...
          className="inline-flex shrink-0 items-center gap-1.5 rounded-2xl bg-white px-4 py-2.5 text-sm font-medium text-black transition-all hover:bg-white/90 active:scale-95"
        >
      ...
      {editingPlan && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#070912]/60 px-4 backdrop-blur-md transition-all">
          <div className="relative max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-[32px] bg-white/[0.03] p-8 ring-1 ring-white/10 backdrop-blur-2xl shadow-2xl">
            <button
            ...
            <p className="mb-8 text-sm text-white/40">Update marketing details, limits, features, and payment gateway links.</p>
      ...
      {isCreateOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#070912]/60 px-4 backdrop-blur-md transition-all">
          <div className="relative max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-[32px] bg-white/[0.03] p-8 ring-1 ring-white/10 backdrop-blur-2xl shadow-2xl">
            ...
            <h2 className="mb-2 text-2xl font-medium tracking-tight text-white">Create New Plan</h2>
            <p className="mb-8 text-sm text-white/40">Define pricing, limits, and features for a new subscription tier.</p>
